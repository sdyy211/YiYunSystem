//
//  personalMegViewController.swift
//  YinYunSystem
//
...
class personalMegViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,HttpProtocol{
    ...
    func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let cusView = UIView()
        cusView.frame = CGRectMake(0, 0, CGRectGetWidth(mytableview.frame),50)
        cusView.backgroundColor = UIColor.groupTableViewBackgroundColor()
        let lab = UILabel()
        lab.frame = CGRectMake(20, 0,CGRectGetWidth(mytableview.frame)-20,50)
        lab.text = "基本信息"
