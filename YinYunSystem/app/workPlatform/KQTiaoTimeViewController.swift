//
//  KQTiaoTimeViewController.swift
//  YinYunSystem
//
...
class KQTiaoTimeViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "UnwindAskForTiaoDone" {
            
            
            let begin = datefor.stringFromDate(beginTime.date)
            let end = datefor.stringFromDate(endTime.date)
            let viewController = segue.destinationViewController as! KQTiaoTableViewController
        ...
        } else if segue.identifier == "UnwindAskForTiao" {
            if begin != nil {
                let viewController = segue.destinationViewController as! KQTiaoTableViewController
